const I18N = {
  en: {
    ...
    "hacker.welcome": "hacker.exe - interactive shell",
    ...
    "hacker.helpLines": [
      ...
      "  exit <app>       - close an app window (portfolio, map, about, contact, comments, donate, hacker)"
    ],
    ...
    "hacker.profileResetFail": "Reset failed.",
  ...
  ru: {
    ...
    "hacker.welcome": "hacker.exe - интерактивная оболочка",
    ...
    "hacker.helpLines": [
      ...
      "  exit <app>       - закрыть окно приложения (portfolio, map, about, contact, comments, donate, hacker)"
    ],
    ...
    "hacker.profileResetFail": "Не удалось сбросить.",
